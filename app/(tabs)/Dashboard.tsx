...
let styles = StyleSheet.create(
{
  ...
  h2: { fontSize: 18, fontWeight: "700", marginBottom: 6, color: "#2E2E2E" },

  section: { gap: 8 },
  row: { flexDirection: "row", gap: 12 },

  btn: { paddingVertical: 12, paddingHorizontal: 16, borderRadius: 12, borderWidth: 1, alignItems: "center" },
  btnPrimary: { backgroundColor: "#5DBB63", borderColor: "#5DBB63" },
  btnSecondary: { backgroundColor: "#FFFFFF", borderColor: "#A6A6A6" },
  btnText: { color: "#FFFFFF", fontWeight: "700" },
  btnTextDark: { color: "#2E2E2E" },
  ...
  cardTitle: { fontSize: 16, fontWeight: "700", color: "#2E2E2E" },
  cardSub: { color: "#A6A6A6", marginTop: 4 },
  ok: { color: "#5DBB63", fontWeight: "700" }
});